...
namespace iTalk
{
    ...
    class iTalk_TextBox_Big : Control
    {
        ...
        private void OnDragDrop(object Obj, KeyEventArgs e)
        {
            MessageBox.Show("hey");
        }
        private void _OnDragDrop(object Obj, KeyEventArgs e)
        {
            MessageBox.Show("hey");
        }
        private void OnDragOver(object Obj, KeyEventArgs e)
        {
            MessageBox.Show("hey");
        }
        private void _OnDragOver(object Obj, KeyEventArgs e)
        {
            MessageBox.Show("hey");
        }
        private void _DragDrop(object Obj, KeyEventArgs e)
        {
            MessageBox.Show("hey");
        }
    ...
    public class iTalk_MenuStrip : MenuStrip
    {
        ...
        public new ControlRenderer Renderer
        {
            ...
            set { base.Renderer = value; Color c = Color.MediumBlue; }
        }
